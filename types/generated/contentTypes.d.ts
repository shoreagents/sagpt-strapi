...
export interface AdminPermission extends Schema.CollectionType {
  ...
  attributes: {
    ...
    > &
      Attribute.Private;
    embedding: Attribute.Relation<'admin::permission', 'morphOne'>;
  };
}
...
export interface AdminUser extends Schema.CollectionType {
  ...
  attributes: {
    ...
    updatedBy: Attribute.Relation<'admin::user', 'oneToOne', 'admin::user'> &
      Attribute.Private;
    embedding: Attribute.Relation<'admin::user', 'morphOne'>;
  };
}
...
export interface AdminRole extends Schema.CollectionType {
  ...
  attributes: {
    ...
    updatedBy: Attribute.Relation<'admin::role', 'oneToOne', 'admin::user'> &
      Attribute.Private;
    embedding: Attribute.Relation<'admin::role', 'morphOne'>;
  };
}
...
export interface AdminApiToken extends Schema.CollectionType {
  ...
  attributes: {
    ...
    > &
      Attribute.Private;
    embedding: Attribute.Relation<'admin::api-token', 'morphOne'>;
  };
}
...
export interface AdminApiTokenPermission extends Schema.CollectionType {
  ...
  attributes: {
    ...
    > &
      Attribute.Private;
    embedding: Attribute.Relation<'admin::api-token-permission', 'morphOne'>;
  };
}
...
export interface AdminTransferToken extends Schema.CollectionType {
  ...
  attributes: {
    ...
    > &
      Attribute.Private;
    embedding: Attribute.Relation<'admin::transfer-token', 'morphOne'>;
  };
}
...
export interface PluginUploadFile extends Schema.CollectionType {
  ...
  attributes: {
    ...
    > &
      Attribute.Private;
    embedding: Attribute.Relation<'plugin::upload.file', 'morphOne'>;
  };
}
...
export interface PluginUploadFolder extends Schema.CollectionType {
  ...
  attributes: {
    ...
    > &
      Attribute.Private;
    embedding: Attribute.Relation<'plugin::upload.folder', 'morphOne'>;
  };
}

export interface PluginOpenAiEmbeddingsEmbedding extends Schema.CollectionType {
...
export interface PluginI18NLocale extends Schema.CollectionType {
  ...
  attributes: {
    ...
    > &
      Attribute.Private;
    embedding: Attribute.Relation<'plugin::i18n.locale', 'morphOne'>;
  };
}
...
export interface PluginUsersPermissionsRole extends Schema.CollectionType {
  ...
  attributes: {
    ...
    > &
      Attribute.Private;
    embedding: Attribute.Relation<'plugin::users-permissions.role', 'morphOne'>;
  };
}
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'plugin::open-ai-embeddings.embedding': PluginOpenAiEmbeddingsEmbedding;
